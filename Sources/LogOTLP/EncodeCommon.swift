...
/// these encoders are duplicated from that package's internal Encoder so this
/// signal package can produce identical bytes without a transitive internal
/// re-export. Byte output is identical for the same input — verified against
/// swift-tracing-otlp / swift-otlp-exporter byte vectors in the test suite.
enum EncodeCommon {
