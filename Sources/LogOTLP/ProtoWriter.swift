...
/// proto3 wire format. Duplicated from swift-otlp-exporter / swift-tracing-otlp;
/// the wire format is stable, the duplication is the cleanest path per
/// RFC-0007's anchor RFC.
struct ProtoWriter {
